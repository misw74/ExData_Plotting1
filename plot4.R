...
par( mfrow=c(2,2))
plot( myDFSmall$DateTime, myDFSmall$Global_active_power, typ="l", xlab="", ylab="Global Active Power")
plot( myDFSmall$DateTime, myDFSmall$Voltage, typ="l", xlab="", ylab="Voltage")
...
plot(  myDFSmall$DateTime, myDFSmall$Global_reactive_power, typ="l", ylab="Global Ractive Power", xlab="")
dev.off()
